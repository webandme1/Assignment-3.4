...
Higher-order functions treat functions just like data, e.g. string, numbers, booleans, objects, arrays. In Javascript, functions can be passed as arguments and returned as functions.
